...
export { ModalExpositorAddComponent } from './modal-expositor/modal-expositor-add/modal-expositor-add.component';
...
export { ModalActividadAddComponent } from '../modals/modal-actividad-add/modal-actividad-add.component';
export { ModalRepositorioAddComponent } from '../modals/modal-repositorio-add/modal-repositorio-add.component';